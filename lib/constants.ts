...
export const SERVICES = [
  ...
  { slug: 'emergency-repair', name: 'Emergency Repair', shortName: 'Emergency', icon: '🚨', description: 'Can\'t get your car out? Door stuck open overnight? We prioritize same-day emergency calls across Coral Springs.' },
